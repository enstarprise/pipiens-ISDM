...
load("01_data/processedCovariates/2.5km/stan_data_init_2.5km_full.RData")
...
# Save 
saveRDS(result$stan_data, "01_data/processedCovariates/2.5km/stan_data_2.5km_5kpixels.rds")
...
save(subset_stan_data, selected_pixels, old_to_new_mapping, result, init_fun,
     ...
     file = "01_data/processedCovariates/2.5km/stan_data_init_2.5km_5kpixels.RData")
