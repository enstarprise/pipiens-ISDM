...
data {
  ...
  matrix[n_grids_total, n_dates] z_temp_obs;  // Observed values (NA coded as specific value)
  matrix[n_grids_total, n_dates] z_rain_obs;  // Observed values
  ...
  matrix[n_grids_total, n_land_covs] z_land;  // Complete predictors
...
transformed parameters {
  ...
  // Compute lambda_thinned for ALL grids
  for (g in 1:n_grids_total) {
