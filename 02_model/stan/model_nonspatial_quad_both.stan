...
//
//   REMOVED:
//     - All GP/NNGP parameters (alpha_gp, rho_gp, w_b1 / w_gp / beta_gp_raw)
//     - All NNGP data inputs (M, NN_ind, NN_dist, NN_distM)
//     - The nngp_w_lpdf() function
//
//   RESTORED:
//     - beta0 as a plain intercept in the linear predictor
//       (in the spatial models, beta0 was absorbed into w_b1)
//
// LINEAR PREDICTOR:
